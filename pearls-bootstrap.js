...
window.fetch=async (input,init)=>{
  ...
  const [baseRes,pearlsRes,lowPriceRes]=await Promise.all([
  ...
  return new Response(JSON.stringify({...base,hotels:[...byId.values()],meta:{...base.meta,...pearls.meta,...lowPrice.meta}}),{
    status:200,
