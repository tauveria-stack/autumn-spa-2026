...
window.fetch=async (input,init)=>{
  ...
  const [baseRes,pearlsRes,lowPriceRes,discoveryRes]=await Promise.all([
  ...
  return new Response(JSON.stringify({...base,hotels:[...byId.values()],meta:{...base.meta,...pearls.meta,...lowPrice.meta,...discovery.meta}}),{
    status:200,
